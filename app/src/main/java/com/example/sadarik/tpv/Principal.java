...
public class Principal extends FragmentActivity {
    ...
    private String baseUrl="http://192.168.1.134:8080/ServletRestaurante/peticiones?target=";
    ...
    class CargarDatos extends AsyncTask<String, Void, String []> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            for(String s:params){
                ...
                r[contador] = pedirDatos("http://192.168.1.134:8080/ServletRestaurante/peticiones?target="+s);
                contador++;
            }
            return r;
        }
